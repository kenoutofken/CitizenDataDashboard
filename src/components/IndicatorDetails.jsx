export default function IndicatorDetails() {
  return (
    <div className="flex flex-wrap gap-8 pt-12 pb-12 px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-15 card bg-base-100 flex-1 shadow-md pt-6 pb-6 px-6">
            {/* LEFT COLUMN */}
            <div>
            ...
            <h3 className="text-[32px] font-semibold mb-2">Ask questions and give feedback</h3>
            <p className="text-gray-700 text-base mb-3">
                Meeting our target requires support from:
            </p>
            ...
            <p className="text-gray-700 text-base mb-2">This indicator aligns with:</p>
            ...
            <ul className="list-disc list-inside space-y-1 text-sky-700 text-base">
                ...
                <li>
                <a href="#" className="link link-hover">
                    Adults who feel safe walking alone in their neighbourhood at night
                </a>
                </li>
                <li>
                <a href="#" className="link link-hover">
